...
const AgentAllAds = ({ data }) => {
  ...
  return (
    <div className="flex flex-row lg:px-24 px-4 pt-10  flex-wrap gap-12 items-center justify-start">
      {data?.length > 0 ? (
        data?.map((item, idx) => {
          return (
            <div className="flex flex-col relative shadow-md p-4 rounded-md lg:border-none border">
              ...
              <div className="flex w-full gap-4 cursor-pointer select-none lg:flex-row flex-col  py-4 lg:py-12">
                <AgentAdSlider images={item?.images} />
                <div className="flex gap-1 w-[130px] lg:absolute  text-red-500 text-xs font-medium  right-4">
                ...
                <div className="flex flex-col gap-12  w-full relative ">
                  ...
                  <div className="flex  justify-between">
                    ...
                    <div className="flex flex-col lg:flex-row lg:text-lg text-sm gap-4 items-center ">
                      <p
                      ...
                      <p
                        className="text-white font-bold lg:text-base lg:px-5  px-3  text-sm bg-red-600 py-2 flex gap-3 items-center"
                        onClick={() => {
                          Swal.fire({
                            title: "Are you sure ?",
                      ...
                      >
                        <Trash2 className="size-5 lg:size-7" />
                        Delete Ad
                      </p>
                    </div>
                  </div>
