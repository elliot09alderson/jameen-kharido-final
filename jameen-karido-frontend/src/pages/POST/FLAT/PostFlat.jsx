...
const PostFlat = () => {
  ...
  const handleSubmit = (values, { resetForm }) => {
    ...
    images.forEach((image) => {
      formData.append("flatsAdImages", image);
    });
    ...
    dispatch(upload_flat_Ad(formData)).then(() => {
    ...
    >
      {({ values, setFieldValue, errors }) => (
        <Form className="max-w-4xl mx-auto p-6 bg-white shadow-md outline:none focus:outline-none rounded-md">
          <h2 className="lg:text-4xl text-3xl font-bold mb-2 py-8 pt-4">
            Enter Flat Details
          </h2>
          ...
          <div className="mb-4">
            ...
            <Field
              ...
              type="text"
              className="w-full outline:none focus:outline-none mt-1 p-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-500"
            />
            <ErrorMessage
              name="location"
              component="div"
